...
def generate_launch_description():
    ...
    bcr_bot_path = get_package_share_directory("goat_description")
    ...
    gz_ros2_bridge = Node(
        ...
        arguments=[
            ...
            "/stereo_camera/left/image@sensor_msgs/msg/Image[ignition.msgs.Image",
            "stereo_camera/right/image@sensor_msgs/msg/Image/Image[ignition.msgs.Image",
